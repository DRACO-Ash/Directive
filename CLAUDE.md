...
● **The audit hash chain is append-only and never truncated.** Changing `FIELD_ORDER`, the hash construction, or the chaining breaks every historical entry, and is an irreversible decision requiring the Managing Director's sign-off.
